...
<div class="panel panel-inverse">
    <div class="panel-heading">
        <h4 class="panel-title">Zep Program</h4>
        ...
        <div class="table-responsive-md">
            ...
            @foreach($data as $row)
                ...
                @endif
                    ...
                    <td>
                        <button onclick="window.location='{{ url("programs/zep/".$row->id."/create-child") }}'" class="m-5 btn-sm btn-gray">Create Child</button>
                        <button onclick="window.location='{{ url("programs/zep/".$row->id) }}'" class="m-5 btn-sm btn-gray">Show</button>
                        <button onclick="window.location='{{ url("programs/zep/checkAncestors2/".$row->id) }}'" class="m-5 btn-sm btn-gray">Check</button>
                    </td>
                    {{-- <td class="row pl-5">
