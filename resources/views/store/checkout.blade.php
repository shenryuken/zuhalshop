...
<div class="invoice">
	...
	<div class="invoice-content">
		...
		<div class="row text-right">
			<form class="form-group" action="{{route('pay')}}" method="get">
				{{-- <div class="row"> --}}
					<br>
					<div class="form-group row">
						<label class="col-md-6 col-form-label">Payment Method:</label>
						<select class="border shadow p-2 bg-white form-control col-md-6" name='payment_method'>
							<option value=''>Select Payment Method</option>
							<option value="paypal">Paypal</option>
							<option value="toyyibpay">FPX (Toyyibay)</option>
						</select>
					</div>
				{{-- </div> --}}
				<button type="submit" class="btn btn-sm btn-primary m-r-5">Pay</button>
			</form>
		</div>
	...
	<div class="invoice-footer">
		...
		<div class="text-center col-md-12">
			<div class="highlightable">
				<div class="payment-options-inner highlighted" id="payment-options-badges">
					<h4>Payment Options</h4>
					<ul>
						<li>
							<img src="https://www.paypalobjects.com/web/res/3eb/bbe9a83ac219389906fd52295b978/img/paypal/cc-badges-US.png" alt="PayPal">
							<img src="{{asset('colorAdmin/img/logo/toyyibpay.png')}}" height="40px">
						</li>
					</ul>
					<div class="pointer"></div>
				</div>
				<div class="tipWrapperContainer">
					<div class="popover-markup alignElementCenter">
