        ...
        <div class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
            <div class="row">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 text-right">
                    <p>
                        <em>Date: {{$invoice->created_at}}</em>
                    </p>
                    <p>
                        <em>Receipt #: {{$invoice->inv_no}}</em>
                    </p>
                </div>
            </div>
            <div class="row">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="col-md-1 text-center">{{$item->subtotal}}</td>
                        </tr>
                        @endforeach
                        <tr>
                            <td>   </td>
                        ...
                        <tr>
                            ...
                            <td class="text-center text-danger"><h4><strong>{{$invoice->amount}}</strong></h4></td>
                        </tr>
                    </tbody>
                </table>
